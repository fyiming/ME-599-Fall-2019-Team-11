...
all = [];
%%
files = dir('E:\ROB535\Final Project\rob535-fall-2019-task-1-image-classification\data-2019\cropped_image/*/*_image.jpg'); %%Change the directory to the location of the training images.
